    ...
    <div class="todolist-body w-full h-screen bg-gray-200">
      ...
      <div>
        <div class="search-btn gap-5 w-full h-[80px] flex items-center border-b-4">
          <div class="all w-[100px] h-[60px] border-2 flex items-center justify-cente text-white rounded-lg" type="button" data-search="all" @click="check = null" :class="active">全部</div>
          <div class="is-todo w-[100px] h-[60px] border-2 flex items-center justify-center text-white rounded-lg" type="button" data-search="isTodo" @click="check = true" :class="active">已執行</div>
          <div class="not-todo w-[100px] h-[60px] border-2 flex items-center justify-cente text-white rounded-lg" type="button" data-search="notTodo"  @click="check= false" :class="active">未執行</div>
        </div>
      </div>
